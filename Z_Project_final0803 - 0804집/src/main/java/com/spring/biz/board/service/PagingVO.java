...
public class PagingVO {
	// 현재페이지, 시작페이지, 끝페이지, 게시글 총 갯수, 페이지당 글 갯수, 마지막페이지, SQL쿼리에 쓸 start, end
		...
		public PagingVO(int total, int nowPage, int cntPerPage, String category, String searchCondition, String searchKeyword) {
			setNowPage(nowPage);
			setCntPerPage(cntPerPage);
			setTotal(total);
			setCategory(category);
		...
		public String toString() {
			return "PagingVO [nowPage=" + nowPage + ", startPage=" + startPage + ", endPage=" + endPage + ", total="
					...
					+ end + ", cntPage=" + cntPage + ", category=" + category + ", searchCondition=" + searchCondition
