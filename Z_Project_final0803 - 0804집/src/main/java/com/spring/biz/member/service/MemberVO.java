...
public class MemberVO {
	private String user_id, user_pw, user_name, user_phone1, user_phone2,
				   user_phone3, user_addr1, user_addr2, user_company,
	...
	public String toString() {
		return "MemberVO [user_id=" + user_id + ", user_pw=" + user_pw + ", user_name=" + user_name + ", user_phone1="
